...
export default function ElectronicSlider() {
  ...
  return (
    <>
      {electronicData ? (
        <div className=" parentElect position-relative  rounded-4 p-2 mt-5 mb-5">
        <h3 className="m-3 pb-2 border-bottom border-1"> Electronic Featured Products </h3>
          <Slider {...settings}>
            {electronicData ? (
              electronicData.map((pro , idx) => {
                return (
                  <div className="test" key={idx}>
                    <div className="item  p-3 border border-1 rounded-3 shadow-sm overflow-hidden bg-white mx-2">
